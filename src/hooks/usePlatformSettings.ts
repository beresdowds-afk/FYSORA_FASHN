...
const DEFAULTS: PlatformSettings = {
  id: "",
  platform_name: "FYSORA FASHN (FYSORA FASHN (Fashion Stitches Africa) Africa)",
  ...
  social_links: {},
  meta_keywords: "",
  copyright_text: "© 2024 FYSORA FASHN (FYSORA FASHN (Fashion Stitches Africa) Africa). All rights reserved.",
  sentinel_mcp_url: "",
  updated_at: "",
};
