...
serve(async (req) => {
  ...
  try {
    ...
    const effectiveOrgName = orgName || "FYSORA FASHN (FYSORA FASHN (Fashion Stitches Africa) Africa)";
    const platformName = "FYSORA FASHN (FYSORA FASHN (Fashion Stitches Africa) Africa)";
